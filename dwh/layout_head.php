...
<head>
	...
	<link rel="stylesheet" href="<?php echo $home_url; ?>libs/js/Bootstrap-Image-Gallery-3.1.1/css/blueimp-gallery.min.css">
		<link rel="stylesheet" href="<?php echo $home_url; ?>libs/js/jQuery.filer-1.3.0/css/jquery.filer">
		<link rel="stylesheet" href="<?php echo $home_url; ?>libs/js/jQuery.filer-1.3.0/css/themes/jquery.filer-dragdropbox-theme.css" type="text/css" rel="stylesheet" />
