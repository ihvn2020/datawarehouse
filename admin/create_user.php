	            ...
	            <td>
					<div class="btn-group" data-toggle="buttons">
						<label class="btn btn-default active">
							<input type="radio" name="group_id" value="1" checked> Dashboard User
						</label>

						<label class="btn btn-default">
							<input type="radio" name="group_id" value="2"> Facility Uploads
						</label>
						<label class="btn btn-default">
							<input type="radio" name="group_id" value="3"> State User
						</label>
						<label class="btn btn-default">
							<input type="radio" name="group_id" value="4"> Admin User
						</label>
